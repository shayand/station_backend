...
public class AttributeServiceImpl implements AttributeService {
  ...
  public @NotNull Attribute getAttributeById(String id) {
    ...
    return attributeRepository.findByIdAndDeletedAtIsNull(id).orElseThrow(
        () -> new NoSuchElementException("Attribute not found or deleted with ID: " + id));
  }
  ...
  public Attribute updateAttribute(String id, Attribute updatedAttribute) {
    ...
    return attributeRepository.findByIdAndDeletedAtIsNull(id).map(existing -> {
